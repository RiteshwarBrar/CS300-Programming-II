//////////////// FILE HEADER //////////////////////////////////////////////////
//
// Title: This is a test program that checks the working of CarrotPatch class 
//
...
public class CarrotPatchTester extends CarrotPatch {
  ...
  public static boolean test2isCloseMethod() {
    ...
    try {
      Wolf w1 = new Wolf();
      Wolf w2 = new Wolf();
      // Set first Wolf at position(400,300)
      w1.setX(400); // Wolf is 200px away from Rabbit
      w1.setY(300);
      // Set second Wolf at position(100,400)
      w2.setX(100); // Wolf is 100px away from Rabbit
      w2.setY(400);
  ...
  public static boolean test3isCloseMethod() {
    ...
    try {
      ...
      // Set first Rabbit at position(200,200)
      r.setX(200);
      r.setY(200);
      // Set (x,y) as position(120,300)
      int x = 50;
      int y = 300;
      if (r.isClose(x, y, Rabbit.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Rabbit.isClose() returned true when it should return false.");
        return false;
      }
